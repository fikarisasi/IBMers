module.exports = function(Employee) {
	...
	Employee.getLeaderboard = function(cb){
		Employee.find({fields: {id: true, username: true, name: true, poin: true, badges: true, badgeCount: true}, order: 'poin DESC'},
			function(err,instance){
				if(instance===null){
					cb(null,null);
				}else{
	...
	Employee.getContacts = function(cb){
		Employee.find({fields: {id:true, username: true, name: true, division:true}},
			function(err,instance){
				if(instance===null){
					cb(null,null);
				}else{
